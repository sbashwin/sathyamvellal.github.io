...
[0 A.D.][12] is a free and open source, historical RTS game. The concept of the game was designed in 2003 and was developed for around six years as a closed-source freeware project. In 2009 the game went open source under the GPL license and art content under CC-BY-SA. This steadily attracted a lot of contributors ranging from art designers to programmers to develop the game. Much of the development and contribution started after the project was open soured.
...
The previous and the current alpha versions have improved the game's performance and added many new features into the game and the next alpha release is bring a host of new features including, performance improvements and a featured Multiplayer Lobby, expected to release soon! No wonder this project pushes the bar up for gaming in Linux open source games.  
